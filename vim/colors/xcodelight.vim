" ISC License
"
" Copyright (c) 2020, Aramis Razzaghipour
" 
...
" Last Updated: Fri 18 Sep 23:24:22 2020
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi MatchParen guifg=#262626 guibg=#fef869 guisp=NONE gui=NONE cterm=NONE
  ...
  hi IncSearch guifg=#262626 guibg=#fef869 guisp=NONE gui=NONE cterm=NONE
  ...
  hi Underlined guifg=#0f68a0 guibg=NONE guisp=NONE gui=underline cterm=underline
  ...
  if g:xcodelight_green_comments
    hi Comment guifg=#2d8504 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi SpecialComment guifg=#2d8504 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Todo guifg=#2d8504 guibg=NONE guisp=NONE gui=bold cterm=bold
  endif
  if g:xcodelight_emph_types
    ...
    hi Typedef guifg=#0f68a0 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi LocalType guifg=#3e8087 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi LibraryType guifg=#804fb8 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  endif
  if g:xcodelight_emph_funcs
    hi FunctionDef guifg=#0b4f79 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi LocalFunc guifg=#23575c guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi LibraryFunc guifg=#4b21b0 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  else
  ...
  if g:xcodelight_emph_idents
    hi IdentifierDef guifg=#0b4f79 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi LocalIdent guifg=#23575c guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi LibraryIdent guifg=#4b21b0 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  else
  ...
  if g:xcodelight_dim_punctuation
    ...
    hi Delimiter guifg=#262626 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Operator guifg=#262626 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  endif
  unlet s:t_Co
  finish
endif
